<template>
  <div class="sidebar">
          ...
          <template #header>
            ...
            >
              <div class="relative">
                <div
                  :class="
                    isLoading.user.current_role_data?.is_online ? 'clip' : ''
                  "
                >
                  <img
                ...
                <img
                  v-if="isLoading.user.current_role_data?.is_online"
              ...
              <div class="flex items-center justify-between w-full">
                ...
                <img
                  :class="store.account_collapse[0] ? 'rotate-180' : ''"
                  class="duration-300"
    ...
    <aside
      class="md:hidden block tabs sidebar_scroll md:overflow-hidden overflow-x-auto"
    >
      <!-- <a-tabs
